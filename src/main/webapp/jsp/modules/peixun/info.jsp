                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>培训开始时间</label>
                                        <input id="peixunOnTime" name="peixunOnTime" class="form-control"
                                               v-model="ruleForm.peixunOnTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>培训结束时间</label>
                                        <input id="peixunDownTime" name="peixunDownTime" class="form-control"
                                               v-model="ruleForm.peixunDownTime" readonly>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="peixunFenshu" name="peixunFenshu" class="form-control"
                                               v-model="ruleForm.peixunFenshu" readonly>
                                    </div>
